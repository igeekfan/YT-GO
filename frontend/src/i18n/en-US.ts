const enUS: typeof import('./zh-CN').default = {
    ...
    'outputDir.serverPathPlaceholder': 'Enter server-side path, e.g. /home/user/Downloads',
    ...
    'settings.cookiesFileWebHint': 'Upload a cookies.txt file to the server for login-required videos',
    'settings.cookiesFileHowTo': 'How to export cookies.txt',
    'settings.outputDirWebHint': 'Enter a server-side file path. Downloaded files will be saved there',
    ...
    'format.mode.combine': 'Combined (Video + Audio)',
    'format.mode.audioOnly': 'Audio Only',
    'format.mode.videoOnly': 'Video Only',
    ...
    'dep.update': 'Update',
    'dep.ytdlpCheckVersion': 'Check Latest',
    'dep.ytdlpCheckingVersion': 'Checking...',
    'dep.ytdlpLatest': '✓ Up to date',
    'dep.ytdlpOutdated': 'Update available',
