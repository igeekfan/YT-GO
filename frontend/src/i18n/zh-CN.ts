const zhCN = {
    ...
    'outputDir.browse': '浏览',
    'outputDir.serverPathPlaceholder': '输入服务器端保存路径，如 /home/user/Downloads',
    ...
    'settings.cookiesFileWebHint': '上传 cookies.txt 文件到服务器，用于需要登录的视频',
    'settings.cookiesFileHowTo': '如何导出 cookies.txt',
    'settings.outputDirWebHint': '请输入服务器端的文件路径，下载的文件将保存到该目录',
    ...
    'format.mode.audioOnly': '仅音频',
    'format.mode.videoOnly': '仅视频',
    'format.video': '视频轨',
    'format.audio': '音频轨',
    ...
    'dep.update': '更新',
    'dep.ytdlpCheckVersion': '检查最新版',
    'dep.ytdlpCheckingVersion': '检查中...',
    'dep.ytdlpLatest': '✓ 已是最新版本',
    'dep.ytdlpOutdated': '有新版本可用',
    'dep.denoInstallGuide': '安装或升级 Deno（推荐）',
    'dep.denoManage': '安装 / 升级 Deno',
    'dep.denoUpdating': '正在安装 / 升级 Deno...',
    'dep.denoUpdateSuccess': 'Deno 维护完成，请重启应用后重新检测',
    'dep.denoUpdateFail': 'Deno 维护失败',
